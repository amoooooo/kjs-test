...
*/
declare function onEvent(name: "player.data_from_server.scanned", handler: (event: Internal.NetworkEventJS) => void);
/**
* Fired when you need to add, change tags of things.
*
* However, due to the type erasure of Java, Probe can not determine what
...
*/
declare function onEvent(name: "client.updateResources", handler: (event: Internal.ClientEventJS) => void);
/**
* Fired when you need to add, change tags of things.
*
* However, due to the type erasure of Java, Probe can not determine what
...
* Can be specified with sub ids for looking up specific channel.
*/
declare function onEvent(name: "player.data_from_server.vis", handler: (event: Internal.NetworkEventJS) => void);
/**
* Fired when you need to add, change tags of things.
*
* However, due to the type erasure of Java, Probe can not determine what
...
* - is post-initializing
*/
declare function onEvent(name: "updateResources", handler: (event: Internal.StartupEventJS) => void);
/**
* Fired when you need to add, change tags of things.
*
* However, due to the type erasure of Java, Probe can not determine what
