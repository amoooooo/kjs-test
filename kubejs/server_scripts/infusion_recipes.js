...
global.recipe_data = {
    "minecraft:diamond_axe": {
        items: ["minecraft:stick", "minecraft:stone"],
        catalyst: "minecraft:diamond",
        fluid: [
            { fluid: "kubejs:perditio_essentia", count: 4 }
        ]
    },
    "minecraft:nether_star": {
        items: ["minecraft:quartz", "minecraft:blaze_rod", "minecraft:heart_of_the_sea"],
        catalyst: "minecraft:nautilus_shell",
        fluid: [
            { fluid: "kubejs:perditio_essentia", count: 8 },
            { fluid: "kubejs:terra_essentia", count: 8 }
        ]
    },
